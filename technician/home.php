<?php
	...
	$incomingMessages	= incomingMessagesTech($_SESSION['id']); // getting incoming messages 
?>
<!DOCTYPE html>
<html lang="en">
	<head>
			...
			<nav class="d-flex justify-content-between align-items-center">
				<div>
					<div class="logo text-light">
						<a href="../technician/home.php">IT Specialist</a>
					</div>
				</div>
				<div class="nav-links d-flex justify-content-center align-items-center">
					<a href="../technician/tech-basket.php" class="text-light basket">
						...
						<div class="bg-light msg position-absolute d-none" style="max-height: 300px; overflow-y: scroll">
							...
							<?php if ($incomingMessages == 0) { ?>
								...
								<?php } else {
									...
									<a href="../technician/tech-chat.php?client-id=<?=$message['sender_id']?>" class="d-block">
										<div class="container">
											<!-- in case there are messages -->
											<div class="row border-bottom mb-1 overflow-hidden p-2">
												<div class="col-2">
													<div class="msg-img overflow-hidden">
														<img src="../assets/imgs/client.jpg" class="w-100 h-100" alt="" />
													</div>
												</div>
												<div class="col-10">
													<h6><?= $message['client_name']?></h6>
													<p class="p-0">
														<?= $message['message']?>
													</p>
												</div>
					...
					<div class="position-relative nav-img me-md-4" title="user-name">
						<img src="../assets/imgs/tech.jpg" class="w-100 rounded-circle" alt="" />
		...
		<div class="hero position-relative">
			<div class="overlay position-absolute d-flex justify-content-center align-items-center">
				<div class="container text-light">
					<h1 class="text-center mb-3">Welcome to IT Specialist</h1>
					<p class="text-center">
						We Are To Help You Anytime For Technical Inquiry Or Technical Services, We Provide Professional Technicians In IT.					</p>
				</div>
			</div>
		</div>
		<!-- end hero -->
