<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === "POST")
    {
        ...
        $login  = authClient($_POST['email'], $_POST['password']);
        if ($login)
        {
			...
			<nav class="d-flex justify-content-between align-items-center">
				...
				<div class="login">
					...
					<a href="../client/register.php" class="px-2 py-1 px-md-3 py-md-2">
						<span class="ps-1"><i class="fa-solid fa-user-plus"></i></span> New Account
					</a>
				</div>
			</nav>
		</header>
		...
		<section class="p-5 bg-light container">
			<form action="" method="POST">
				...
				<div>
					...
					<a href="../technician/login-tech.php" class="login-as">Sign In As Technician!</a>
				</div>
